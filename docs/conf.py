...
# -*- coding: utf-8 -*-
"""
vlcbot documentation build configuration file.
...
src_path = os.path.abspath(os.path.join(docs_src_path, '..', 'vlcbot'))
...
project = u'vlcbot'
_full_version = vlcbot.__version__
author = vlcbot.__author__
copyright = vlcbot.__copyright__
...
latex_documents = [
    (master_doc, 'vlcbot.tex', u'vlcbot Documentation',
     u'authors', 'manual'),
]
...
man_pages = [
    (master_doc, 'vlcbot', 'vlcbot Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'vlcbot', 'vlcbot Documentation',
     author, 'vlcbot', vlcbot.__descr__,
     'Miscellaneous'),
]
